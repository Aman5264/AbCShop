                                ...
                                @else
                                    <form action="{{ route('cart.coupon.apply') }}" method="POST" class="mb-4">
                                        ...
                                        <div class="flex space-x-2">
                                            <input type="text" name="coupon_code" id="coupon_code" placeholder="Enter coupon code" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-md border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm shadow-sm">
