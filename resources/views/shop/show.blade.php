                        ...
                        <div class="mt-10 p-6 bg-gray-50 rounded-2xl border border-gray-100">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4">
                                ...
                                <form action="{{ route('wishlist.toggle', $product->id) }}" method="POST">
                                    @csrf
                                    <button type="submit" class="h-full px-5 bg-gray-100 rounded-xl text-gray-500 hover:text-red-500 hover:bg-red-50 transition shadow-lg flex items-center justify-center" title="Add to Wishlist">
                                    ...
                                    <div class="flex gap-4">
                                        @for($i=1; $i<=5; $i++)
                                            <label class="cursor-pointer">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-8 h-8 text-gray-300 peer-checked:text-yellow-400 hover:text-yellow-400 transition">
                                                    <path fill-rule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clip-rule="evenodd" />
                                                </svg>
                                            </label>
                                        @endfor
